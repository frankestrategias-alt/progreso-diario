...
import { Sparkles, ArrowRight, CheckCircle2, Trophy, Rocket, Target, Briefcase, Gem } from 'lucide-react';
    ...
    const steps = [
        {
            ...
            description: (
                <>
                    Genera mensajes profesionales para prospectar y dar seguimiento usando{" "}
                    <span className="text-slate-800 font-bold">inteligencia artificial</span>.
                </>
            ),
        ...
        },
        {
            ...
            description: "Tus resultados son prioridad.\nMide tu actividad cada día y\nsupera tus propias metas.",
            icon: <Trophy className="text-emerald-500" size={48} />,
            color: "from-emerald-400 to-teal-500"
        },
        {
            title: "¡Empieza Aquí! 💎",
            description: "Tu primera meta hoy es invitar a tu negocio. Pulsa el botón y empieza a prospectar.",
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-slate-900 flex items-center justify-center p-6">
            <div className="bg-white w-full max-w-md rounded-[40px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-500">
                <div className={`h-44 bg-gradient-to-br ${currentStep.color} flex items-center justify-center p-8 transition-all duration-500`}>
